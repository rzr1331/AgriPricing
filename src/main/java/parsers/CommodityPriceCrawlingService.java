...
import parsers.nfed.NafedCrawlingService;
...
public class CommodityPriceCrawlingService {
    ...
    private NafedCrawlingService nafedCrawlingService = new NafedCrawlingService();
    ...
    public void crawlCommodityPrice(CommodityPriceSource commodityPriceSource, Long date) {
        ...
        switch (commodityPriceSource) {
            ...
            case COMMODITY_ONLINE:
                ...
                break;
            case NAFED:
                crawlCommodityPriceDtos= nafedCrawlingService.handleRequest();
                break;
        }
