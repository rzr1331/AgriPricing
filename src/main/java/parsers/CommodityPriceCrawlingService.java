...
import parsers.jindalpanther.JindalPantherCrawlingService;
...
public class CommodityPriceCrawlingService {
    ...
    private JindalPantherCrawlingService jindalPantherCrawlingService = new JindalPantherCrawlingService();
    ...
    public void crawlCommodityPrice(CommodityPriceSource commodityPriceSource, Long date) {
        ...
        switch (commodityPriceSource) {
            ...
            case COMMODITY_ONLINE:
                ...
                break;
            case JindalPanther:
                crawlCommodityPriceDtos= jindalPantherCrawlingService.handleRequest();
                break;
        }
