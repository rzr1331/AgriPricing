...
import parsers.CommodityInsigtsx.CommodityInsightsxCrawlingService;
...
public class CommodityPriceCrawlingService {
    ...
    private CommodityInsightsxCrawlingService commodityInsightsxCrawlingService=new CommodityInsightsxCrawlingService();
    ...
    public void crawlCommodityPrice(CommodityPriceSource commodityPriceSource, Long date) {
        ...
        switch (commodityPriceSource) {
            ...
            case COMMODITY_ONLINE:
                ...
                break;
            case COMMODITYINSIGHTSX:
                crawlCommodityPriceDtos=commodityInsightsxCrawlingService.handleRequest(date);
                break;
        }
