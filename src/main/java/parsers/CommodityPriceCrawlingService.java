...
import parsers.JswNeoSteel.JSWNeoSteelCrawlingService;
...
public class CommodityPriceCrawlingService {
    ...
    private JSWNeoSteelCrawlingService jswNeoSteelCrawlingService = new JSWNeoSteelCrawlingService();
    ...
    public void crawlCommodityPrice(CommodityPriceSource commodityPriceSource, Long date) {
        ...
        switch (commodityPriceSource) {
            ...
            case COMMODITY_ONLINE:
                ...
                break;
            case JSWNEOSTEEL:
                crawlCommodityPriceDtos=jswNeoSteelCrawlingService.handleRequest();
                break;
        }
